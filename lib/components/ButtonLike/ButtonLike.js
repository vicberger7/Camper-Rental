...
import { addFavorite, deleteFavorite, storageKey } from '../../redux/favorites/favoritesSlice';
...
export const ButtonLike = ({
  ...
  const handleLike = () => {
    const updatedLikedItems = isLike ? likedCamps.filter(camp => camp !== item._id) : [...new Set([...likedCamps, item._id])];
  ...
  return /*#__PURE__*/React.createElement(ButtonLikeWrapper, {
    onClick: handleLike
  }, /*#__PURE__*/React.createElement(IconLike, null, /*#__PURE__*/React.createElement(IconLikeUse, {
